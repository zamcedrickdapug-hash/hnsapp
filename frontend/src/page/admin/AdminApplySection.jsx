...
export default function AdminApplySection({
  registrations,
  statusFilter,
  declineReasons,
  loading,
  ...
  return (
    <section className="admin-section admin-apply-section">
        ...
        {registrations.map((registration) => (
          <article className="registration-card" key={registration.id}>
            ...
            <section className="id-block">
              ...
              <button type="button" onClick={() => onPreviewValidId(registration.id)}>
                Preview Valid ID
              </button>
            </section>
            ...
            <section className="actions-block">
              <textarea
                ...
                onChange={(event) => onDeclineReasonChange(registration.id, event.target.value)}
              />
              ...
              <div className="button-row">
                <button
                  ...
                  onClick={() => onUpdateStatus(registration.id, 'reviewing')}
                >
                  Set Reviewing
                </button>
                <button
