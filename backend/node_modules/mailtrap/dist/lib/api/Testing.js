...
class TestingAPI {
    constructor(client, accountId) {
        this.projects = new Projects_1.default(client, accountId);
        this.inboxes = new Inboxes_1.default(client, accountId);
        this.messages = new Messages_1.default(client, accountId);
        this.attachments = new Attachments_1.default(client, accountId);
    }
}
